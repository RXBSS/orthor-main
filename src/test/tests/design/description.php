...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class='card'>
                <div class='card-body'>
                    <h4><i class='fas fa-info-circle'></i> Was ist Orthor?</h4>

                    <p>
                        Orthor ist der Projektname für ein komplettes Framework. Das Framework soll dazu diene eine schnelle Grundlage zu schaffen um in die Entwicklung einzusteigen und diese erheblich zu vereinfachen.
                        Dabei stellt es alle Grundfunktionen dar sowie diverse Add-Ons dar.
                    </p>
                    <p>
                        Das Grundlegende System basiert auf Bootstrap 5. Hier wurde mit Hilfe von Sass ein eigenes Theme entwicklelt.<br>
                        Dieses Theme umfasst auch die Einbindung von Drittsystemen, die als Third-Party-Produkete gelistet sind.
                        Dabei wird zwischen Plugins unterschieden, die auf jeder Seite vorhanden sind und welche, die zwar vom Design angepasst wurden, aber trotzdem separat eingebunden werden müssen.
                    </p>
                    <p>
                        Neben den Third-Party-Komponenten werden auch eigene Komponenten (die Teilweise auf Third-Party Produkte aufbauen) integriert.
                        Diese werden als Module bezeichnet.
                    </p>
                </div>
            </div>
            ...
            <br>
            <br>
            <center><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="307px" height="307px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">

                    <g>
                        <animateTransform attributeName="transform" type="rotate" values="360 50 50;0 50 50" keyTimes="0;1" dur="2.02s" repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1" begin="-0.202s"></animateTransform>
                        <circle cx="50" cy="50" r="39.891" stroke="#fac8dd" stroke-width="14.4" fill="none" stroke-dasharray="0 300">
                            <animate attributeName="stroke-dasharray" values="15 300;55.1413599195142 300;15 300" keyTimes="0;0.5;1" dur="2.02s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.09292s"></animate>
                        </circle>
                        <circle cx="50" cy="50" r="39.891" stroke="#ffffff" stroke-width="7.2" fill="none" stroke-dasharray="0 300">
                            <animate attributeName="stroke-dasharray" values="15 300;55.1413599195142 300;15 300" keyTimes="0;0.5;1" dur="2.02s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.09292s"></animate>
                        </circle>
                        <circle cx="50" cy="50" r="32.771" stroke="#000000" stroke-width="1" fill="none" stroke-dasharray="0 300">
                            <animate attributeName="stroke-dasharray" values="15 300;45.299378454348094 300;15 300" keyTimes="0;0.5;1" dur="2.02s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.09292s"></animate>
                        </circle>
                        <circle cx="50" cy="50" r="47.171" stroke="#000000" stroke-width="1" fill="none" stroke-dasharray="0 300">
                            <animate attributeName="stroke-dasharray" values="15 300;66.03388996804073 300;15 300" keyTimes="0;0.5;1" dur="2.02s" repeatCount="indefinite" calcMode="linear" keySplines="0 0.4 0.6 1;0.4 0 1 0.6" begin="-0.09292s"></animate>
                        </circle>
                    </g>
                    <g>
                        <animateTransform attributeName="transform" type="rotate" values="360 50 50;0 50 50" keyTimes="0;1" dur="2.02s" repeatCount="indefinite" calcMode="spline" keySplines="0.5 0 0.5 1"></animateTransform>
